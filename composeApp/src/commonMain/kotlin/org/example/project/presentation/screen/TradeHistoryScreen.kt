...
object TradeHistoryScreen : Screen{
    @Composable
    override fun Content() {
        val navigator: Navigator? = LocalNavigator.currentOrThrow
        TradeHistoryScreen(navigator,{})
    }
...
@Composable
@Preview
fun TradeHistoryScreen(navigator: Navigator?,onBack:()->Unit={}){
    ...
    Column(
        ...
        Column(
            ...
            Row(
                ...
                Text("История Заказов", fontWeight = FontWeight.Bold, fontSize = 16.sp, color = Color.White)
            }
        }
    }
}