...
object ActivityLogForAdminScreen : Screen{
    @Composable
    override fun Content() {
        val navigator: Navigator?= LocalNavigator.currentOrThrow
        ActivityLogForAdminScreen(navigator,{})
    }
...
@Composable
@Preview
fun ActivityLogForAdminScreen(navigator: Navigator?,onBack:()-> Unit){
    Column(
        modifier = Modifier
            .fillMaxSize()
        ...
        Column(
            ...
            Row(
                ...
                Text("Журнал действий", fontWeight = FontWeight.Bold, fontSize = 16.sp, color = Color.White)
            }
        }
    }
}