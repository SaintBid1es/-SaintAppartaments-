...
object CategoryManagmentScreen : Screen {
    @Composable
    override fun Content() {
        val navigator: Navigator? = LocalNavigator.currentOrThrow

        CategoryManagmentScreen(navigator,{})
    }
...
@Composable
@Preview
fun CategoryManagmentScreen(navigator: Navigator?,onBack:()->Unit={}){
    Column(
        modifier = Modifier
            .fillMaxSize()
        ...
        Column(
            ...
            Row(
                ...
                Text("Управление категориями", fontWeight = FontWeight.Bold, fontSize = 16.sp, color = Color.White)
            }
        }
    }
}