...
class UpdateInformationScreenClass(val user: User?) : Screen {
    @Composable
...
@Composable
@Preview
fun UpdateInformationScreen(navigator: Navigator?,user: User?,onBack:()-> Unit={}){
    val viewModel = remember { UpdateViewModel() }
    ...
    Column(
        ...
        Row(
            ...
            Text(text = "Изменение  информации аккаунта", fontSize = 20.sp)
        }
        Column(
