...
object ModerationListingScreen : Screen{
    @Composable
    override fun Content() {
        val navigator: Navigator? = LocalNavigator.currentOrThrow
        ModerationListingScreen(navigator,{})
    }
...
@Composable
@Preview
fun ModerationListingScreen(navigator: Navigator?,onBack:()->Unit={}){
    Column(
        modifier = Modifier
            .fillMaxSize()
        ...
        Column(
            ...
            Row(
                ...
                Text("Модерация объявлений", fontWeight = FontWeight.Bold, fontSize = 16.sp, color = Color.White)
            }        }
    }
}